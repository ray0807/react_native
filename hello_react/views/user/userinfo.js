            ...
            <ScrollView>
                <View style={{backgroundColor: 'white'}}>
                    ...
                    <View style={{
                        ...
                        <Text
                            style={{color: '#C251C0', fontSize: 16, flex: 1, alignSelf: 'center', textAlign: 'center'}}>FEED</Text>
                        <Text
                            style={{color: '#545351', fontSize: 16, flex: 1, alignSelf: 'center', textAlign: 'center'}}>PHOTOS</Text>
                    </View>
